...
activities = {
    ...
    "Digital Art Studio": {
        "description": "Create digital artwork using design software and graphics tablets",
    ...
    "Science Club": {
        "description": "Explore scientific concepts through experiments and field studies",
        "schedule": "Fridays, 2:00 PM - 3:30 PM",
        "max_participants": 22,
        "participants": ["chris@mergington.edu", "ashley@mergington.edu"]
    }
}
